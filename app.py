...
import traceback
import time
from cutlery.DatasetKitchen import DatasetManager, TemplateManager, FileHandler
...
def load_template(template_name):
    ...
    print(f"LOAD_TEMPLATE:888888888888888888888888888888 {template}")
    if template is None:
...
def run_agent_chef():
    data = request.json
    print(f"RUN_PAYLOAD_DATA:888888888888888888888888888888 {data}")
...
def list_prompt_sets():
    ...
    print(f"PROMPTSET PAYLOAD: FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF {files}")
